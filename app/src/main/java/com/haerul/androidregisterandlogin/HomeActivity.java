...
public class HomeActivity extends AppCompatActivity {
    ...
    Bitmap bitmap;
    Bitmap image;
    String urlUpload = "https://www.rocketjaket.com/api/upload";
    Uri image_uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama_view = findViewById(R.id.nama_view);
        ...
        btnChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent maps = new Intent(HomeActivity.this, AbsenMasukActivity.class);
                startActivity(maps);
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent maps = new Intent(HomeActivity.this, AbsenPulangActivity.class);
                startActivity(maps);
...
//        return encodedImage;
//
////    Bitmap returnBitmap = BitmapFactory.decodeResource(getResources(), bitmap);
////
////    String encodedImage = Base64.encodeToString(returnBitmap,Base64.DEFAULT);
////    return encodedImage;
//
//    }
}
