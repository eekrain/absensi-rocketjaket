...
public class ProsesAbsenPulangActivity extends AppCompatActivity {
    ...
    Bitmap bitmap;
    Bitmap image;
    String urlUpload = "https://www.rocketjaket.com/api/Absennotshift/prosesAbsenPulang";
    Uri image_uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent maps = new Intent(ProsesAbsenPulangActivity.this, AbsenPulangActivity.class);
                askCameraPermission();
            ...
            public void onClick(View v) {
                StringRequest stringRequest = new StringRequest(Request.Method.POST, urlUpload, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent intent = new Intent(ProsesAbsenPulangActivity.this,HomeActivity.class);
...
//                        String imageData = "";
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(ProsesAbsenPulangActivity.this);
